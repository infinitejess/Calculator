//Creates obj to keep track of values
const Calculator = {
    Display_Value: '0', //Displays 0 on screen
    First_Operand: null, //this will hold first operand, but null for now
    Wait_Second_Operand: false, //checks whether or not the second operand has been input
    operator: null, //hold the operator, null for now
};
